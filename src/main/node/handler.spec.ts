...
describe('handler', () => {
  process.env.authorizedIps = '10.10.10.10';
  ...
  const testMsgs = {
    ...
    Messages: 
      [ { MessageId: 'fakedid',
         ...
         Attributes: {SenderId: 'JEJRKEJRKEJK', ApproximateFirstReceiveTimestamp: '1521761799883', ApproximateReceiveCount: '1', SentTimestamp: '1521761769677'}
     }]
  };
  ...
  describe('syncUser function', () => {
    it('should return 403 Forbidden', async () => {
      handler.syncUser(null, null, (x, response) => {
  ...
  describe('syncGroup function', () => {
    it('should return 200 OK', async () => {
      ...
      when(gwsMock.parseUpdateMembers(anything())).thenReturn({addMembers:['tuser1'],deleteMembers:[],updateMembers:['tuser1']});
